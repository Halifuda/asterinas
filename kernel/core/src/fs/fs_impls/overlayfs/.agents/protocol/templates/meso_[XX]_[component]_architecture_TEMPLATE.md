...
- **Macro-Owner**: `<Target_Macro_Owner>` (e.g., `Inode`)
...
|---|---|---|
| e.g., `Zero-fill gap` | Linux filesystem / Issue #0413 | Must fill uninitialized space with zeros when extending file size |
