...
`kernel/src/fs/fs_impls/exfat_refactor/.agents/protocol/XFSTESTS_LIGHTWEIGHT_TRIAGE.md`.
...
```sh
kernel/src/fs/fs_impls/exfat_refactor/.agents/tools/xfstests_run.sh {case_or_batch_or_direct} {case_args} --phase {phase} {extra_harness_args}
```
