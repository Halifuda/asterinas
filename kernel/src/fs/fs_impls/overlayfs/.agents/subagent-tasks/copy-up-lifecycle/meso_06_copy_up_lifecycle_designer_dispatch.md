...
# Designer Dispatch: copy_up_lifecycle

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `copy-up-lifecycle`
**Parent Meso-Component:** `copy_up_lifecycle`
**Covered Micro-Features:** P1-01, P1-02, P1-03, P1-04, P1-05, P1-06, P1-07, P1-34
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_06_copy_up_lifecycle_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/copy-up-lifecycle/meso_06_copy_up_lifecycle_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/copy-up-lifecycle/meso_06_copy_up_lifecycle_designer_validation.md`
