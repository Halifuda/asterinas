...
# Designer Dispatch: directory_mutations_whiteouts

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `directory-mutations-whiteouts`
**Parent Meso-Component:** `directory_mutations_whiteouts`
**Covered Micro-Features:** P1-21, P1-22, P1-23, P1-24, P1-25, P1-26, P1-27, P1-28, P1-29, P1-30, P1-36, P2-02
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_09_directory_mutations_whiteouts_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/directory-mutations-whiteouts/meso_09_directory_mutations_whiteouts_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/directory-mutations-whiteouts/meso_09_directory_mutations_whiteouts_designer_validation.md`
