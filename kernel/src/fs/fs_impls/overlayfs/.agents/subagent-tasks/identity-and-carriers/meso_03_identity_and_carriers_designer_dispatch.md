...
# Designer Dispatch: identity_and_carriers

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `identity-and-carriers`
**Parent Meso-Component:** `identity_and_carriers`
**Covered Micro-Features:** P0-04, P0-06, P0-07, P0-12, P0-15, P0-16, P0-17, P2-01, P2-15, P3-08
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_03_identity_and_carriers_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/identity-and-carriers/meso_03_identity_and_carriers_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/identity-and-carriers/meso_03_identity_and_carriers_designer_validation.md`
