...
# Designer Dispatch: xattr_namespace_escaping

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `xattr-namespace-escaping`
**Parent Meso-Component:** `xattr_namespace_escaping`
**Covered Micro-Features:** P1-33, P2-13, P2-14
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_10_xattr_namespace_escaping_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/xattr-namespace-escaping/meso_10_xattr_namespace_escaping_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/xattr-namespace-escaping/meso_10_xattr_namespace_escaping_designer_validation.md`
