...
# Designer Dispatch: merged_readdir_cache

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `merged-readdir-cache`
**Parent Meso-Component:** `merged_readdir_cache`
**Covered Micro-Features:** P0-13, P0-14, P1-31, P2-03
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_05_merged_readdir_cache_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/merged-readdir-cache/meso_05_merged_readdir_cache_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/merged-readdir-cache/meso_05_merged_readdir_cache_designer_validation.md`
