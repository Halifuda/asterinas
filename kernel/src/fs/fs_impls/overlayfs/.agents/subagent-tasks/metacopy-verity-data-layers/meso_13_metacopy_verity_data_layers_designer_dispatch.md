...
# Designer Dispatch: metacopy_verity_data_layers

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `metacopy-verity-data-layers`
**Parent Meso-Component:** `metacopy_verity_data_layers`
**Covered Micro-Features:** P3-03, P3-04, P3-05
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_13_metacopy_verity_data_layers_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/metacopy-verity-data-layers/meso_13_metacopy_verity_data_layers_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/metacopy-verity-data-layers/meso_13_metacopy_verity_data_layers_designer_validation.md`
