...
# Designer Dispatch: path_lookup_visibility

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `path-lookup-visibility`
**Parent Meso-Component:** `path_lookup_visibility`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_04_path_lookup_visibility_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/path-lookup-visibility/meso_04_path_lookup_visibility_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/path-lookup-visibility/meso_04_path_lookup_visibility_designer_validation.md`
