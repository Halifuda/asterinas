...
# Designer Dispatch: inode_attributes_security

**Role ID:** DESIGNER
**Pass Kind:** Meso-Level Dynamic Contract + External Validation Contract
**Component/Task Group:** `inode-attributes-security`
**Parent Meso-Component:** `inode_attributes_security`
**Covered Micro-Features:** P1-16, P1-17, P1-18, P1-32, P2-05, P2-06, P2-07
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/architect-global-topology/meso_08_inode_attributes_security_architecture.md`
...
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/inode-attributes-security/meso_08_inode_attributes_security_designer_spec.md`
- `kernel/src/fs/fs_impls/overlayfs/.agents/components/inode-attributes-security/meso_08_inode_attributes_security_designer_validation.md`
