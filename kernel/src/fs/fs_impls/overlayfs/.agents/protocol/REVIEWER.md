...
- **NO KTEST EDITS**: Do not add, rewrite, or preserve ktest-based validation as an accepted strategy. Only explicitly packeted xfstests harness/configuration changes outside `kernel/src/fs/fs_impls/` may be reviewed.
