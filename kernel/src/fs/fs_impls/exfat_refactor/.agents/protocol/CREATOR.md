...
4. **Entity Generation Whitelist (Strict Helper Rules)**: You are forbidden from inventing private helpers, inline structs, or accessors unless they satisfy exactly one of these strict constraints:
