...
- Packet file: `kernel/src/fs/fs_impls/exfat_refactor/.agents/subagent-tasks/EXR-BITMAP-08A/20260404-1444-final-checker-packet.md`
- Supersedes: none
- Role: checker
- Component: `EXR-BITMAP-08A`
- Phase: final checker
- Authorizing main agent: main-agent
- Date: 2026-04-04 14:44 CST

## Goal

- Run the post-review final checker for `EXR-BITMAP-08A` by rerunning the focused local bitmap ktests under the checker lock and recording the evidence in `31_checker_final.md`. Do not add new tests unless the review artifact proves they are necessary.
...
- `kernel/src/fs/fs_impls/exfat_refactor/.agents/components/EXR-BITMAP-08A/31_checker_final.md`
...
- Use `Q-CHECK`
- In scope:
  - confirming the reviewed implementation still passes the focused local bitmap ktests
...
- Acquire command shape:
  - `/home/halifuda/asterinas/kernel/src/fs/fs_impls/exfat_refactor/.agents/tools/checker_lock.sh acquire --component EXR-BITMAP-08A --phase final-checker --command "docker exec codex-asterinas-dev bash -lc 'cd /root/asterinas/kernel && cargo osdk test bitmap::tests'" --retry-seconds 60 --wait-budget-seconds 1800`
...
- Stop after rerunning the focused local bitmap ktests and writing `31_checker_final.md`.
