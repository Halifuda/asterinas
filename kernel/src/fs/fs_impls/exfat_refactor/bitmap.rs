...
// TODO: `MountVolumeStateError` is a temporary cross-owner seam for bitmap
...
impl AllocationBitmap {
    ...
    pub(super) fn find_free_ranges(
        ...
        Err(MountVolumeStateError::NoSpace)
    }
    ...
    pub(super) fn apply_update(
        ...
        while bitmap_bytes_remaining != 0 {
            ...
            current_cluster = match fat_reader.next_cluster(current_cluster)? {
                ...
                FatChainStep::End => return Err(MountVolumeStateError::InconsistentAccounting),
            };
        }
    ...
    fn bitmap_lengths(
        ...
        cluster_count: usize,
        boot_region: &BootRegion,
    ) -> core::result::Result<(usize, usize), MountVolumeStateError> {
