...
XFSTESTS_MOUNT_OPTIONS ?= -o noacl
XFSTESTS_DIRECT_COMMAND ?=
XFSTESTS_DIRECT_COMMAND_B64 ?=
XFSTESTS_DIRECT_WORKDIR ?= /opt/xfstests/test
...
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_FSTYP=$(XFSTESTS_FSTYP)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_MKFS=$(XFSTESTS_MKFS)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_MKFS_OPTIONS=$(XFSTESTS_MKFS_OPTIONS)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_FSCK=$(XFSTESTS_FSCK)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_MOUNT_OPTIONS=$(XFSTESTS_MOUNT_OPTIONS)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_DIRECT_COMMAND=$(XFSTESTS_DIRECT_COMMAND)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_DIRECT_COMMAND_B64=$(XFSTESTS_DIRECT_COMMAND_B64)"
CARGO_OSDK_BUILD_ARGS += --kcmd-args="XFSTESTS_DIRECT_WORKDIR=$(XFSTESTS_DIRECT_WORKDIR)"
endif
